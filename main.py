...
# conf = r'-c tessedit_char_whitelist='+string.ascii_letters   # detect alphabets only.
conf = r'-c tessedit_char_whitelist=' + string.digits


#conf = conf + string.ascii_letters  # detect numeric digits and alphabets both.
